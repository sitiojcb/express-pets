...
// ---abrimos el pop up con el form
function openOverlay(el) {
  //equiparo el id
  document.querySelector(".form-content").dataset.id = el.dataset.id;
  //cambio el placeholder por el nombre dinamicamente
...
function closeOverlay() {
  ...
  document.querySelector(":root").style.overflowY = ""; //lo hago visible nuevamente
}
//----------
document
  ...
  .addEventListener("submit", async function (e) {
    ...
    // console.log("los valores ", userValues);
    ...
    //--muestra mensaje al dar click al submit btn
